...
#define BOTHER 0010000
        ...
        void SerialPort::Open()
        {
            ...
            // std::cout << "Inside LinuxCPP:  " << device_.c_str();
            ...
            if (flock(fileDesc_, LOCK_EX | LOCK_NB) == -1)
            {
                // throw std::runtime_error("Serial port with file descriptor " +\
                                         std::to_string(fileDesc_) + " is already locked by another process.");
                // Close();
                std::cout << "Serial port with file descriptor " << std::to_string(fileDesc_) << " is already locked by another process." << std::endl;
                // std::cout << "HELLOOOO\n";
                exit(10);
            }
            ...
            std::cout << "COM port opened successfully." << fileDesc_ << std::endl;
            state_ = State::OPEN;
        }
        ...
        void SerialPort::Write(const std::string &data)
        {
            ...
            // std::cout << "Received: " << writeResult << std::endl;
